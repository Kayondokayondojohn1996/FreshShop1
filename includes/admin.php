...
body {
  ...
  background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.5)), url('images/instagram-img-08.jpg ');
	height: 100vh;
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><i class="fa fa-cogs"></i> Freshshop</h4></a>
                </div>
    
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span> Adding / Updating product <span class="caret"></span></a>
...
<div class="container">
   <form id="formFilter" name="formFilter" action="admin_reservefilter.php" method="POST" class="pull-left col-md-7 hidden-print">
        ...
        <div class="form-horizontal wow fadeInDown">            
                <label for="filter" class="control-label" style="font-size:16px; font-weight:bold; color: grey;">  <i class="glyphicon glyphicon-filter"></i> VIEW RECORDS</label>
            <div class="col-md-6">  
    ...
    <div class="col-md-12" style="border: solid #D9D9D9 1px; padding: 10px; padding-top: 5px; box-shadow: #9F9F9F 2px 3px 5px; margin-top: 10px;">
           <p class="wow fadeInDown" style="font-size:16px; font-weight:bold; color: pink;"><em>Order List</em></p>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2021 <a target="_blank" href="#" title="#">Freshshop</a>. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
