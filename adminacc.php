...
body {
  ...
  background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.5)), url('instagram-img-08.jpg');
	height: 100vh;
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <div class="col-md-6" style="border: solid #CFCFCF 2px; border-radius: 10px; background-color:pink;">
        <div class="alert alert-success" id="infomsg" style="text-align: center"></div> 
        <center><img src="images/john.jpg" class="img-responsive wow fadeInDown" style="height:200px;  width: 50%;" /></center>
        <div>
            <?php
                session_start();
