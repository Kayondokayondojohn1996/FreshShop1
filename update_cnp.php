...
body {
  ...
  background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.5)), url('images/Bike-wheel-chain-rusty_1920x1200.jpg ');
	height: 100vh;
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown active"><a class="dropdown-toggle wow fadeInDown" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-th"></span>updating product/Adding <span class="caret"></span></a>
