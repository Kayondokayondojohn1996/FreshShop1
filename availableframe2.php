<meta charset="utf-8">
    ...
    <title>bikeshop Online store</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <h4 class="wow fadeInDown" style="margin-top:0px; color:#FFF;"> 
                <img src="images/mtb-silhouette-white-264x300.png"  width="50px "/>  bikeshop online store</h4></a>
                </div>
                
                <div class="collapse navbar-collapse navbar-right wow fadeInDown">
                    <ul class="nav navbar-nav">
                        <li> <li id="logout" class="wow fadeInDown"><a id="logoutbtn" href='<?php echo "logout_process.php?logout=1"?>'><span class="glyphicon glyphicon-share"></span> Logout</a></li></li>
    ...
    $result=mysqli_query($con, $sql);
			if(mysqli_num_rows($result)==5){
					echo '<script>alert("You reach maximum order of 5");
								window.loaction.href="availableframe2.php";</script>';
				}
				else{
        ...
        $result=mysqli_query($con, $sql);
							if($result==true){
								echo '<script>alert("Your order will be process.The system will follow up by contacting your number thankyou!");
											 window.location.href="availableframe2.php"</script>';}
											 else{
